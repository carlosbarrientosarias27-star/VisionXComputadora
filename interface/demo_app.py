...
class VisionXApp(ctk.CTk):
    ...
    def setup_ui(self):
        ...
        self.result_area = ctk.CTkTextbox(self.right_col, fg_color="#111111", corner_radius=8, border_width=1, border_color="#333")
        self.result_area.pack(fill="both", expand=True, padx=20, pady=(15, 20))

        # --- BOTÓN INFERIOR ---
        self.classify_btn = ctk.CTkButton(self.left_col, text="🚀 CLASIFICAR", height=38, width=200, 
                                        font=ctk.CTkFont(size=13, weight="bold"),
                                        fg_color="#44bd32", hover_color="#2ecc71")
        self.classify_btn.pack(fill="x", padx=0, pady=(15,0))
